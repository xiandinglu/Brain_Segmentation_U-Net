...
def unet():
    ...
    conv4 = Conv2D(512, (3, 3), activation='relu', padding='same', kernel_regularizer=l2(0.01))(pool3)
    batch4 = BatchNormalization(axis=1)(conv4)
    conv4 = Conv2D(512, (3, 3), activation='relu', padding='same', kernel_regularizer=l2(0.01))(batch4)
    batch4 = BatchNormalization(axis=1)(conv4)
    pool4 = MaxPooling2D((2, 2))(batch4)

    conv5 = Conv2D(1024, (3, 3), activation='relu', padding='same', kernel_regularizer=l2(0.01))(pool4)
    batch5 = BatchNormalization(axis=1)(conv5)
    conv5 = Conv2D(1024, (3, 3), activation='relu', padding='same', kernel_regularizer=l2(0.01))(batch5)
    batch5 = BatchNormalization(axis=1)(conv5)

    up6 = Conv2DTranspose(512, (2, 2), strides=(2, 2), padding='same', kernel_regularizer=l2(0.01))(batch5)
    up6 = concatenate([up6, conv4], axis=1)
    conv6 = Conv2D(512, (3, 3), activation='relu', padding='same', kernel_regularizer=l2(0.01))(up6)
    batch6 = BatchNormalization(axis=1)(conv6)
    conv6 = Conv2D(512, (3, 3), activation='relu', padding='same', kernel_regularizer=l2(0.01))(batch6)
    batch6 = BatchNormalization(axis=1)(conv6)

    up7 = Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='same', kernel_regularizer=l2(0.01))(batch6)
